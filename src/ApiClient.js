...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SaqueEPagueSonda.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost/saqueepague-sonda/v1
     */
    this.basePath = 'https://localhost/saqueepague-sonda/v1'.replace(/\/+$/, '');
