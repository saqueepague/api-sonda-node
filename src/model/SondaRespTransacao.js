...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SaqueEPagueSonda.SondaRespTransacao = factory(root.SaqueEPagueSonda.ApiClient);
  }
  ...
  /**
   * The SondaRespTransacao model module.
   * @module model/SondaRespTransacao
   * @version 1.1.1-sw2
   */

  /**
   * Constructs a new <code>SondaRespTransacao</code>.
   * Objeto de resposta que contem o estado da transação sondada. Caso não encontre a transação vai retornar estado pendente.
   * @alias module:model/SondaRespTransacao
   * @class
   */
  ...
  /**
   * Constructs a <code>SondaRespTransacao</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SondaRespTransacao} obj Optional instance to populate.
   * @return {module:model/SondaRespTransacao} The populated <code>SondaRespTransacao</code> instance.
   */
