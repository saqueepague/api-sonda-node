...
(function(root, factory) {
  ...
  describe('SondaApiControllerApi', function() {
    describe('sondaPostUsingPOST', function() {
      it('should call sondaPostUsingPOST successfully', function(done) {
        //uncomment below and update the code to test sondaPostUsingPOST
        //instance.sondaPostUsingPOST(function(error) {
