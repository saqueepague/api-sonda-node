...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SaqueEPagueSonda.SondaApiControllerApi();
  });
  ...
  describe('SondaApiControllerApi', function() {
    describe('saqueepagueSondaPost', function() {
      it('should call saqueepagueSondaPost successfully', function(done) {
        //uncomment below and update the code to test saqueepagueSondaPost
        //instance.saqueepagueSondaPost(function(error) {
