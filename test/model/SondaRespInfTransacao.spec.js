...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SaqueEPagueSonda.SondaRespInfTransacao();
  });
  ...
  describe('SondaRespInfTransacao', function() {
    it('should create an instance of SondaRespInfTransacao', function() {
      ...
      //var instance = new SaqueEPagueSonda.SondaRespInfTransacao();
      //expect(instance).to.be.a(SaqueEPagueSonda.SondaRespInfTransacao);
    });
